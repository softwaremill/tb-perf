#!/usr/bin/env python3
"""Plot results from TigerBeetle run on 2026-07-14"""
import pandas as pd
import matplotlib.pyplot as plt

# Read the detailed CSV data
df = pd.read_csv('2026-07-14-tigerbeetle-detail.csv')

# Create figure with subplots
fig, axes = plt.subplots(2, 2, figsize=(14, 10))
fig.suptitle('TigerBeetle Performance - Fixed Rate Test (2026-07-14)', fontsize=16, fontweight='bold')

# Plot 1: TPS per run
ax = axes[0, 0]
ax.bar(df['run_number'], df['tps'], color='coral', alpha=0.7, edgecolor='black')
...
for i, v in enumerate(df['tps']):
    ax.text(df['run_number'].iloc[i], v + 30, f'{v:.1f}', ha='center', va='bottom', fontsize=10)
...
plt.tight_layout()
plt.savefig('2026-07-14-tigerbeetle.png', dpi=300, bbox_inches='tight')
print("Graph saved to 2026-07-14-tigerbeetle.png")
print(f"\nTigerBeetle Performance Summary:")
