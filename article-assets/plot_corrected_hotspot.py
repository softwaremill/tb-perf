...
b2 = ax.bar(x, pg_standard, width, label="PostgreSQL Standard (FOR UPDATE)", color="#2f6690")
b3 = ax.bar(x + width, pg_atomic, width, label="PostgreSQL Atomic", color="#5fa8d3")
...
b1 = ax.bar(x - width / 2, c5k, width, label="concurrency5k (target=5,000)", color="#e8743b")
b2 = ax.bar(x + width / 2, r10k, width, label="rate10k (target=10,000)", color="#f4a261")
